...
<div class="bg-white p-4 rounded shadow-sm border col-md-8">
    <form action="{{ route('admin.coupons.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="code" name="code" value="{{ old('code') }}" required style="text-transform:uppercase">
        ...
        <div class="mb-3">
            ...
            <input type="number" step="0.01" class="form-control" id="min_cart_amount" name="min_cart_amount" value="{{ old('min_cart_amount', 0) }}" required>
            <small class="text-muted">Minimum total cart value required to apply this coupon.</small>
        ...
        <div class="row">
            ...
            <div class="col-md-6 mb-3">
                ...
                <input type="number" class="form-control" id="usage_limit_per_user" name="usage_limit_per_user" value="{{ old('usage_limit_per_user') }}">
