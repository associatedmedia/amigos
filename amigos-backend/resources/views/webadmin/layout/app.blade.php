                ...
                <nav id="sidebarMenuWrapper" class="col-md-3 col-lg-2 d-md-block bg-white border-end sidebar collapse px-0">
                    <div class="position-sticky pt-3 d-flex flex-column" style="height: calc(100vh - 56px);">
                        <ul class="nav flex-column mb-auto" id="sidebarMenu">
                            ...
                            <li class="nav-item">
                                ...
                                <div class="collapse {{ request()->routeIs('admin.orders.*') ? 'show' : '' }}" id="ordersCollapse" data-bs-parent="#sidebarMenu">
                                    <ul class="nav flex-column mb-0 py-2 bg-light border-bottom">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link {{ request()->routeIs('admin.order-statuses.*') ? 'fw-bold text-primary' : 'text-secondary' }}" href="{{ route('admin.order-statuses.index') }}">Order Statuses</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            ...
                            <!-- Coupons Menu -->
                            <li class="nav-item">
                                <a class="nav-link py-3 border-bottom d-flex justify-content-between align-items-center {{ request()->routeIs('admin.coupons.*') ? 'active bg-light fw-bold text-dark' : 'text-secondary' }}" 
                                   data-bs-toggle="collapse" href="#couponsCollapse" role="button" aria-expanded="{{ request()->routeIs('admin.coupons.*') ? 'true' : 'false' }}">
                                    <span><i class="bi bi-ticket-perforated me-2"></i> Coupons</span>
                                    <i class="bi bi-chevron-down small"></i>
                                </a>
                                <div class="collapse {{ request()->routeIs('admin.coupons.*') ? 'show' : '' }}" id="couponsCollapse" data-bs-parent="#sidebarMenu">
                                    <ul class="nav flex-column mb-0 py-2 bg-light border-bottom">
                                        <li class="nav-item">
                                            <a class="nav-link {{ request()->routeIs('admin.coupons.create') ? 'fw-bold text-primary' : 'text-secondary' }}" href="{{ route('admin.coupons.create') }}">Add Coupon</a>
                                        </li>
                                        <li class="nav-item">
                                            <a class="nav-link {{ request()->routeIs('admin.coupons.index') ? 'fw-bold text-primary' : 'text-secondary' }}" href="{{ route('admin.coupons.index') }}">List Coupons</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
